	...
	_init: function(options) {
		...
		this.currFocused = 0;
		   ...
		   var pageWidth='100%';       var pageHeight='100%';    
                ...
                // We use this instead of simply setting width and height to 100% in css
                // to avoid the IE6 removing the scrollbar on modalbox overlay display behavior.
                //alert("  " + pageWidth + "  " + pageHeight)
                Element.setStyle('MB_overlay', {width: pageWidth, height: pageHeight});
	},
