    ...
    <tr>
      <td valign="top"><!-- bof  breadcrumb -->
        ...
        <div class="centerColumn" id="accountDefault"> <br />
          ...
          <!-- <h2>My Account</h2> -->
          <a href="/index.jsp?main_page=account_edit">View or change my account information.</a><br />
          <a href="/index.jsp?main_page=address_book">View or change entries in my address book.</a><br />
