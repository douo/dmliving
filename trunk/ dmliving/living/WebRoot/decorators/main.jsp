      ...
      <div id="layout-header-nav">
        <table align="right" width="100%" border="0" cellpadding="0" cellspacing="0" height="34">
          <tr>
            ...
            <td bgcolor="#333333" align="center" width="40%"><a href="#">my account</a> &nbsp;|&nbsp; <a href="user/register.action">login</a> &nbsp;|&nbsp; <a href="#"><img src="images/shopping_cart_empty.gif" alt="" width="20" height="12" align="absbottom" /></a> &nbsp;<a href="#" class="green-link">shopping cart</a>
              <!-- (<?= $items_in_bag ?>) --></td>
